        ...
        return (
            <div>
                <div className="confInfo">
                    ...
                    <div className="flex-containerB" id="confBA">
                        <div className="left"><b>BTC Address:</b> <br/><div className="confBF">{btcAddress}</div></div>
                        <div className="right"/>
    ...
    function ConfirmationSubmission() {
        return (
            <div className="confSubmission">
                ...
                <CheckMark/>
                <button type="button" id="confButton1" className="confWRS" onClick={() => setConf("concl")}><b>Continue</b></button>
            </div>
        )
    }
