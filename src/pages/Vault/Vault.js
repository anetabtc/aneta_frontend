            ...
            <div className="vault-set-up">
                ...
                <div className="vault-amount-block">
                    ...
                    <div className="vault-input-block">
                        <img src={require('../img/vault_icon.png')} id="vault-icon"/>
    ...
    function MyVault() {
        return (
            <div className="my-vault-block">
                ...
                <div className="my-vault-but"><div className="gradient-button" onClick={(e) => setActive(0)}>Close Vault</div></div>
            </div>
        )
    }
    ...
    <div className="page">
        <div className="main-block">
            ...
            <div className="content-block">
                {active == 0 && (
                    <div className="gradient-button" id="operate-button" onClick={(e) => setActive(1)}>Operate an anetaBTC vault </div>
                )}
